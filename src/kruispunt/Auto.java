...
public class Auto implements Runnable{
     ...
     * gesorteerd op hun ID.
     * De auto begint met 1 tot 2 seconde rondjes rijden en komt dan bij het 
     * kruispunt aan. Elke zone wordt om de beurt gereserveerd.
     * Dan wordt elke zone om de beurt weer vrijgegeven en wordt er geprint
     * welke richting de auto op is gegaan. Daarna begint dit weer opnieuw.
     */
    @Override
    public void run() {
        while(true){
            try {
                ...
                Arrays.sort(nodig);
                Thread.sleep(r1.nextInt(1000) + 1000);
